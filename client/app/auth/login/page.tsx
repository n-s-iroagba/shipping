  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0B1D3A] via-[#0f2847] to-[#0B1D3A] p-4">
      <div className="w-full max-w-md">
        ...
        {/* Security Notice */}
        <div className="mt-6 bg-white/5 backdrop-blur border border-white/10 rounded-xl p-4 text-center">
          <div className="flex items-center justify-center mb-2">
            <svg className="w-5 h-5 text-[#C9A84C] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
            </svg>
            <span className="text-sm text-white/70 font-medium">Secure & Encrypted</span>
          </div>
          <p className="text-[10px] text-white/40 tracking-wider uppercase">256-bit TLS Protection</p>
        </div>
      </div>
    </div>
  );
